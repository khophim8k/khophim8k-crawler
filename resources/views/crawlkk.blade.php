...
@section('content')
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <div class="form-group">
                                <select class="custom-select col-4" name="movies-get-params">
                                    ...
                                    <option value="full">Lấy full phim</option>
                                </select>
    ...
    <script>
        ...
        $("#movies-get-handle").click(async function() {
            ...
            const apiUrl = params === 'full' 
                ?"{{ backpack_url('plugin/kkphim-crawler/get-all-movies') }}" // URL để lấy toàn bộ phim
                :"{{ backpack_url('plugin/kkphim-crawler/get-movies') }}";
            ...
            const response = await fetch(apiUrl, {
                ...
                body: JSON.stringify({
                    params: params !== 'full' ? params :
                        undefined // Không gửi params nếu chọn "full"
                })
            });

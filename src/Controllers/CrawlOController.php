...
use Kho8k\Crawler\Kho8kCrawler\CrawlerO;
 ...
 */
class CrawlOController extends CrudController
{
    ...
    public function showCrawlPage(Request $request)
    {
        ...
        return view('khophim8k-crawler::crawlo', compact('fields', 'regions', 'categories'));
    }
    ...
    public function crawl(Request $request)
    {
        ...
        try {
            ...
            $crawler = (new CrawlerO($link, request('fields', []), request('excludedCategories', []), request('excludedRegions', []), request('excludedType', []), request('forceUpdate', false)))->handle();
        } catch (\Exception $e) {
